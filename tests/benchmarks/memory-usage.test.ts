...
describe("Memory Usage Benchmarks", () => {
  ...
  describe("Fast mode (no embeddings) - Target: <100MB", () => {
    ...
    test("100 tools: memory footprint documented", () => {
      ...
      console.log(`  100 tools: before=${beforeMB.toFixed(2)}MB, after=${afterMB.toFixed(2)}MB, delta=${deltaMB.toFixed(2)}MB`);
    ...
    test("500 tools: memory footprint documented", () => {
      ...
      console.log(`  500 tools: before=${beforeMB.toFixed(2)}MB, after=${afterMB.toFixed(2)}MB, delta=${deltaMB.toFixed(2)}MB`);
    ...
    test("1000 tools: memory footprint documented", () => {
      ...
      console.log(`  1000 tools: before=${beforeMB.toFixed(2)}MB, after=${afterMB.toFixed(2)}MB, delta=${deltaMB.toFixed(2)}MB`);
